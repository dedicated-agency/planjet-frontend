...
export const TopProjectBar = (props: IProps) => {
  ...
  return (
    <>
      <header style={{top: (state.isAtBottom && isMobileDevice) ? "35px": 0}} className='transition-all fixed z-20 h-[56px] bg-white w-full max-w-[700px] mx-auto flex justify-between items-center border-b px-[20px]'>
