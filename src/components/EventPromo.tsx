  ...
  return (
    <div className='h-auto bg-white rounded-2xl p-3'>
      ...
      <p
        ...
        style={{ fontFamily: "SF Pro Display" }}
      >
        Нарисовать дизайн главного экрана используая UI-kit компании Нарисовать
        дизайн главного экрана используая UI-kit компании
      </p>
      <div className='bg-customIndigo120 h-auto rounded-xl border-l-[3px] border-customIndigo100 p-3 mt-1'>
        <div className='h-5 flex justify-between items-center cursor-pointer' onClick={() => setisOpenDescription(!isOpenDescription)}>
          <p
          ...
          <div className={`${!isOpenDescription ? 'rotate-90' : 'rotate-[-90deg]'} duration-300 transition-all`}>
          ...
          <div className='mt-3'>
            <div className='mt-3'>
              ...
              <div className='flex gap-2 mt-1'>
                <div className='w-[3px] h-auto bg-customIndigo500 rounded-full' />
                <div className='p-2'>
